...
export default class BoardListViewEntity{
    ...
    @ViewColumn({name:'favorite_count'})
    ...
    @ViewColumn({name:'writer_email'})
    writerEmail:string;

    @ViewColumn({name:'writer_nickname'})
    writerNickname:string;

    @ViewColumn({name:'writer_profile_image'})
